...
namespace Desafio_OElementoExiste.desafio.Classes
{
    public class FuncoesDasafio
    {
        private readonly List<string> _nomesDosEscolhidos = new List<string>()
            {
                "Bruce Wayne",
                "Carlos Vilagran",
                "Richard Grayson",
